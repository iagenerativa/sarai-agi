...
pytestmark = [
    pytest.mark.requires_requests,
    pytest.mark.requires_diskcache  # Cache tests require diskcache
]
...
def disable_safe_mode():
    """Desactiva Safe Mode para todos los tests RAG"""
    with patch('sarai_agi.agents.rag.is_safe_mode', return_value=False):
